...
> python .\main.py -i .\data\input_100.csv -a 1     <- comando para ejecutar el programa main.py con archivos de entrada

existe un parámetro el cual es requerido:

--input ó -i        <- parámetro que indica la ruta del archivo de entrada.
--algorithm ó -a    <- parámetro que indica el algoritmo a ejecutar.
